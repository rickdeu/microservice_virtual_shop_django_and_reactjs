          ...
          <div className='row'>
            ...
            <div className='col-3'>
              ...
              <div className='footer-links d-flex flex-column'>
                <Link className='text-white py-2 mb-1'>Politicas de Privacidade</Link>
                <Link className='text-white py-2 mb-1'>Politicas de Reembolso</Link>
                <Link className='text-white py-2 mb-1'>Politicas de Entrega</Link>
                <Link className='text-white py-2 mb-1'>Termos & Condições</Link>
                <Link className='text-white py-2 mb-1'>Noticias</Link>
