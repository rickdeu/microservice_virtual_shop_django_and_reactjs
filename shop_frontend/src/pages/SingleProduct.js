...
const SingleProduct = () => {
    ...
    const props = {
        ...
        height: 600,
        zoomWidth: 500,
        img: product.image ? product.image : watch
    };
...

                                                    {
                                                        product.product_images ?
                                                            product.product_images.map((img) => (
                                                                <div> <img src={img.image} alt={img.label} width='100%' height={200} /> </div>
                                                            )) :
                                                            null
                                                    }
                                                ...
                                                <div className='main-product-details'>
                                                    ...
                                                    <div className='border-bottom py-3'>
                                                        ...
                                                        <div className='d-flex gap-10 align-items-center my-3'>
                                                            ...
                                                            <a href='javascript:void(0)' onClick={() => { copyToclipboard(product.image) }}>
                                                                Copy Product Link
                                                            </a>
                                                        </div>
